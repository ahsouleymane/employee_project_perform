...
urlpatterns = [
    ...
    path('reset_password/', 
        auth_views.PasswordResetView.as_view(template_name='employee_register/reset_password.html'), 
            name='reset_password'),
    path('reset_password_sent/', 
        auth_views.PasswordResetDoneView.as_view(template_name='employee_register/reset_password_sent.html'), 
            name='reset_password_sent'),
    path('reset/<uidb64>/<token>/', 
        auth_views.PasswordResetConfirmView.as_view(template_name='employee_register/reset_password_confirm.html'), 
            name='reset_password_confirm'),
    path('reset_password_complete/', 
        auth_views.PasswordResetCompleteView.as_view(template_name='employee_register/reset_password_complete.html'), 
